  ...
  <div class="hero-content flex-col lg:px-10 lg:flex-row-reverse">
    ...
    <div>
      ...
      <div className='flex justify-between'>
          <img src={google} className='border-2 border-zinc-300 p-3 rounded-full hover:shadow-lg' alt="" />
          <div className='ml-5'>
      ...
      <div className='flex justify-between my-8'>
          <img src={seo} className='border-2 border-zinc-300 p-3 rounded-full hover:shadow-lg' alt="" />
          <div className='ml-5'>
      ...
      <div className='flex justify-between'>
          <img src={browser} className='border-2 border-zinc-300 p-3 rounded-full hover:shadow-lg' alt="" />
          <div className='ml-5'>
